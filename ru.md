...
Это действие GitHub автоматически генерирует и отправляет локализованные версии вашего файла README.md на основе поддерживаемых языков.
...
<details>
<summary>Доступные языки для перевода (короткий адреса)</summary>
...
Например, если вы хотите создать файлы README для сербского, итальянского и английского языков, ваша конфигурация будет выглядеть следующим образом:
...
И вы можете просмотреть, как работать с действием, нажав на эти виджеты:
<div align="center">
