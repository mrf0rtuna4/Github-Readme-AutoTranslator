...
> [!УВАГА]
> Ми використовуємо лише TRANSLATION DeepL
>
> Це може вплинути на якість перекладу. Це також може призвести до того, що система MIS-ідентифікує ваші файли.

Ця дія GitHub автоматично створює та надсилає локалізовані версії вашого файлу README.md на основі підтримуваних мов.

## Використання

Щоб використати цю дію, створіть файл робочого процесу (наприклад, `.github/workflows/translate.yml`) у своєму сховищі з таким вмістом:
...
Замініть `LANGS` списком мов, розділених комами, які ви хочете створити.
<details>
<summary>Доступні мови для перекладу (повні посилання)</summary>
...
<details>
<summary>Доступні мови для перекладу (короткі адреси)</summary>
...
Наприклад, якщо ви хочете створити файли README для сербської, італійської та англійської мов, ваша конфігурація виглядатиме так:
...
Цей проект ліцензовано згідно з ліцензією Массачусетського технологічного інституту - подробиці див. у файлі [LICENSE](LICENSE).