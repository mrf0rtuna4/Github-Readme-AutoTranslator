...
Ця дія GitHub автоматично створює та надсилає локалізовані версії ваших файлів *.md на основі підтримуваних мов.
...
- `FILES`: розділений комами список файлів для перекладу.
- `МОВИ`: розділений комами список мов для створення.
...
Цей проект ліцензовано згідно з ліцензією MIT - подробиці див. у файлі [LICENSE](LICENSE).